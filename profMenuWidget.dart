    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text(
            widget.title,
            style: TextStyle(fontWeight: FontWeight.w400, color: widget.textColor),
          ),
          trailing: widget.endIcon
              ? RotationTransition(
                  ...
                  child: Container(
                    ...
                    child: Icon(_isExpanded? Icons.keyboard_arrow_up_outlined:Icons.keyboard_arrow_right_outlined  , size: 18.0, color: Colors.white),
                  ),
                )
              : null,
        ),
