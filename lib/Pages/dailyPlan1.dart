...
import 'package:exam/Pages/food_plan/widget/class.dart';
import 'package:exam/Pages/food_plan/widget/food_list.dart';
import 'package:exam/Pages/food_plan/widget/food_list_view.dart';
...
class _DailyPlan1State extends State<DailyPlan1> {
  ...
  Widget build(BuildContext context) {
    double PROGRESS = Week[widget.count].kcal/2071>1? Week[widget.count].kcal/2071-1 : Week[widget.count].kcal/2071 ;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: const TextStyle(decoration: TextDecoration.underline, color: Colors.white, fontSize: 17),),
                                  //DailyRoutine
                                  const Text(
                                    'Daily Routine: ',
                                    style: TextStyle(
                      ...
                      Row(
                        children: [
                          _RadialProgress(height: H * 0.15, width: W * 0.3, progress: PROGRESS, index: widget.count),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _DietProgress(
          ingredient: 'Protein', 
          leftAmount: (Week[index].prot/139*100).toInt()>100? '+${((Week[index].prot/139*100)-100).toInt().toString()}' : '-${(100-Week[index].prot/139*100).toInt().toString()}', 
        ...
        _DietProgress(
          ingredient: 'Carbs', 
          leftAmount: (Week[index].carbs/376*100).toInt()>100? '+${((Week[index].carbs/376*100)-100).toInt().toString()}' : '-${(100-Week[index].carbs/376*100).toInt().toString()}', 
        ...
        _DietProgress(
          ingredient: 'Fat', 
          leftAmount: (Week[index].fat/67*100).toInt()>100? '+${((Week[index].fat/67*100)-100).toInt().toString()}' : '-${(100-Week[index].fat/67*100).toInt().toString()}', 
            ...
            Stack(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: ProgressColor,borderRadius: const BorderRadius.all(Radius.circular(5))),
                ),
              ],
            ),
          ...
          child: RichText(
            ...
            text: TextSpan(
              children: [
                ...
                TextSpan(
                    text: progress>1? '+${((progress-1)*100).toInt().toString()}%\n(Average Value)' : '-${(100-(progress*100)).toInt().toString()}%\n(Average Value)' ,
                    //######################################################################
                    style: const TextStyle(
